...
type Mutator interface {
	...
	RotL64(d Reg, s1, s2 Reg)
	RotL32(d Reg, s1, s2 Reg)
	RotR64(d Reg, s1, s2 Reg)
	RotR32(d Reg, s1, s2 Reg)
	AndInv(d Reg, s1, s2 Reg)
	OrInv(d Reg, s1, s2 Reg)
	Xnor(d Reg, s1, s2 Reg)
	Max(d Reg, s1, s2 Reg)
	MaxU(d Reg, s1, s2 Reg)
	Min(d Reg, s1, s2 Reg)
	MinU(d Reg, s1, s2 Reg)
	CmovIfNotZeroImm(d Reg, c Reg, s uint32)
	RotR64Imm(d Reg, s1 Reg, s2 uint32)
	RotR64ImmAlt(d Reg, s1 Reg, s2 uint32)
	RotR32Imm(d Reg, s1 Reg, s2 uint32)
	RotR32ImmAlt(d Reg, s1 Reg, s2 uint32)
