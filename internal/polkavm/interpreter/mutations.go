...
func (i *Instance) LoadImm64(dst polkavm.Reg, imm uint64) {
	i.setAndSkip64(dst, imm)
}

// StoreImmU8 store_imm_u8 μ′↺νX = νY mod 28
func (i *Instance) StoreImmU8(address uint32, value uint32) error {
	return i.store(address, uint8(value))
}

// StoreImmU16 store_imm_u16 μ′↺{νX...+2} = E2(νY mod 2^16)
func (i *Instance) StoreImmU16(address uint32, value uint32) error {
	return i.store(address, uint16(value))
}

// StoreImmU32 store_imm_u32 μ′↺{νX...+4} = E4(νY mod 2^32)
func (i *Instance) StoreImmU32(address uint32, value uint32) error {
	return i.store(address, uint32(value))
}

// StoreImmU64 store_imm_u64 μ′↺{νX...+8} = E8(νY)
func (i *Instance) StoreImmU64(address uint32, value uint32) error {
	return i.store(address, uint64(value))
}

// Jump jump branch(νX , ⊺)
func (i *Instance) Jump(target uint32) error {
	return i.branch(true, target)
}

// JumpIndirect jump_ind djump((ωA + νX) mod 2^32)
func (i *Instance) JumpIndirect(base polkavm.Reg, offset uint32) error {
	return i.djump(uint32(i.regs[base]) + offset)
}

// LoadImm load_imm ω′A = νX
func (i *Instance) LoadImm(dst polkavm.Reg, imm uint32) {
	i.setAndSkip32(dst, imm)
}

// LoadU8 load_u8 ω′A = μ↺_νX
func (i *Instance) LoadU8(dst polkavm.Reg, address uint32) error {
	slice := make([]byte, 1)
	if err := i.memory.Read(address, slice); err != nil {
		return err
	}
	i.setAndSkip64(dst, uint64(slice[0]))
	return nil
}

// LoadI8 load_i8 ω′A = X1(μ↺_νX)
func (i *Instance) LoadI8(dst polkavm.Reg, address uint32) error {
	slice := make([]byte, 1)
	if err := i.memory.Read(address, slice); err != nil {
		return err
	}
	i.setAndSkip64(dst, uint64(int8(slice[0])))
	return nil
}

// LoadU16 load_u16 ω′A = E−1_2 (μ↺_{νX...+2})
func (i *Instance) LoadU16(dst polkavm.Reg, address uint32) error {
	var v uint16
	if err := i.load(address, 2, &v); err != nil {
		return err
	}
	i.setAndSkip64(dst, uint64(v))
	return nil
}

// LoadI16 load_i16 ω′A = X2(E−1_2 (μ↺_{νX...+2})
func (i *Instance) LoadI16(dst polkavm.Reg, address uint32) error {
	var v int16
	if err := i.load(address, 2, &v); err != nil {
		return err
	}
...
func (i *Instance) LoadU32(dst polkavm.Reg, address uint32) error {
	var v uint32
	if err := i.load(address, 4, &v); err != nil {
		return err
	}
	i.setAndSkip32(dst, v)
	return nil
}

// LoadI32 load_i32 ω′A = X4(E−1_4(μ↺_{νX...+4}))
func (i *Instance) LoadI32(dst polkavm.Reg, address uint32) error {
	var v int32
	if err := i.load(address, 4, &v); err != nil {
		return err
	}
...
func (i *Instance) LoadU64(dst polkavm.Reg, address uint32) error {
	var v uint64
	if err := i.load(address, 8, &v); err != nil {
		return err
	}
	i.setAndSkip64(dst, v)
	return nil
}

// StoreU8 store_u8 μ′↺_νX = ωA mod 2^8
func (i *Instance) StoreU8(src polkavm.Reg, address uint32) error {
	return i.store(address, uint8(uint32(i.regs[src])))
}

// StoreU16 store_u16 μ′↺_{νX...+2} = E2(ωA mod 2^16)
func (i *Instance) StoreU16(src polkavm.Reg, address uint32) error {
	return i.store(address, uint16(uint32(i.regs[src])))
}

// StoreU32 store_u32 μ′↺_{νX...+4} = E4(ωA mod 2^32)
func (i *Instance) StoreU32(src polkavm.Reg, address uint32) error {
	return i.store(address, uint32(uint32(i.regs[src])))
}

// StoreU64 store_u64 μ′↺_{νX...+8} = E8(ωA)
func (i *Instance) StoreU64(src polkavm.Reg, address uint32) error {
	return i.store(address, uint64(uint32(i.regs[src])))
}

// StoreImmIndirectU8 store_imm_ind_u8 μ′↺_{ωA+νX} = νY mod 2^8
func (i *Instance) StoreImmIndirectU8(base polkavm.Reg, offset uint32, value uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint8(value))
}

// StoreImmIndirectU16 store_imm_ind_u16 μ′↺_{ωA+νX...+2} = E2(νY mod 2^16)
func (i *Instance) StoreImmIndirectU16(base polkavm.Reg, offset uint32, value uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint16(value))
}

// StoreImmIndirectU32 store_imm_ind_u32 μ′↺_{ωA+νX...+4} = E4(νY mod 2^32)
func (i *Instance) StoreImmIndirectU32(base polkavm.Reg, offset uint32, value uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint32(value))
}

// StoreImmIndirectU64 store_imm_ind_u64 μ′↺_{ωA+νX...+8} = E8(νY)
func (i *Instance) StoreImmIndirectU64(base polkavm.Reg, offset uint32, value uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint64(value))
}

// LoadImmAndJump load_imm_jump branch(νY , ⊺), ω′A = νX
func (i *Instance) LoadImmAndJump(ra polkavm.Reg, value uint32, target uint32) error {
	i.LoadImm(ra, value)
	return i.Jump(target)
}

// BranchEqImm branch_eq_imm branch(νY, ωA = νX)
func (i *Instance) BranchEqImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) == valueX, target)
}

// BranchNotEqImm branch_ne_imm branch(νY, ωA ≠ νX)
func (i *Instance) BranchNotEqImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) != valueX, target)
}

// BranchLessUnsignedImm branch_lt_u_imm branch(νY , ωA < νX)
func (i *Instance) BranchLessUnsignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) < valueX, target)
}

// BranchLessOrEqualUnsignedImm branch_le_u_imm branch(νY, ωA ≤ νX)
func (i *Instance) BranchLessOrEqualUnsignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) <= valueX, target)
}

// BranchGreaterOrEqualUnsignedImm branch_ge_u_imm branch(νY, ωA ≥ νX)
func (i *Instance) BranchGreaterOrEqualUnsignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) >= valueX, target)
}

// BranchGreaterUnsignedImm branch_gt_u_imm branch(νY, ωA > νX)
func (i *Instance) BranchGreaterUnsignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(uint32(i.regs[regA]) > valueX, target)
}

// BranchLessSignedImm branch_lt_s_imm branch(νY, Z8(ωA) < Z8(νX))
func (i *Instance) BranchLessSignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
...
func (i *Instance) BranchLessOrEqualSignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(int32(uint32(i.regs[regA])) <= int32(valueX), target)
}

// BranchGreaterOrEqualSignedImm branch_ge_s_imm branch(νY, Z8(ωA) ≥ Z8(νX))
func (i *Instance) BranchGreaterOrEqualSignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(int32(uint32(i.regs[regA])) >= int32(valueX), target)
}

// BranchGreaterSignedImm branch_gt_s_imm branch(νY, Z8(ωA) > Z8(νX))
func (i *Instance) BranchGreaterSignedImm(regA polkavm.Reg, valueX uint32, target uint32) error {
	return i.branch(int32(uint32(i.regs[regA])) > int32(valueX), target)
}

// MoveReg move_reg ω′D = ωA
func (i *Instance) MoveReg(dst polkavm.Reg, s polkavm.Reg) {
	i.setAndSkip32(dst, uint32(i.regs[s]))
}
...
func (i *Instance) CountSetBits32(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(uint32(bits.OnesCount32(uint32(i.regs[s]))))
}
...
func (i *Instance) LeadingZeroBits64(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(bits.LeadingZeros64(i.regs[s]))
}
...
func (i *Instance) LeadingZeroBits32(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(uint32(bits.LeadingZeros32(uint32(i.regs[s]))))
}
...
func (i *Instance) TrailingZeroBits64(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(bits.TrailingZeros64(i.regs[s]))
}
...
func (i *Instance) TrailingZeroBits32(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(uint32(bits.TrailingZeros32(uint32(i.regs[s]))))
}

// SignExtend8 sign_extend_8 ω′D = Z−1_8(Z_1(ωA mod 2^8))
func (i *Instance) SignExtend8(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(int64(int8(uint8(i.regs[s]))))
}

// SignExtend16 sign_extend_16 ω′D = Z−1_8(Z_2(ωA mod 2^16))
func (i *Instance) SignExtend16(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(int64(int16(uint16(i.regs[s]))))
}

// ZeroExtend16 zero_extend_16 ω′D = ωA mod 2^16
func (i *Instance) ZeroExtend16(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = uint64(uint16(i.regs[s]))
}

// ReverseBytes reverse_bytes ∀i ∈ N8 ∶ E8(ω′D)i = E8(ωA)_7−i
func (i *Instance) ReverseBytes(dst polkavm.Reg, s polkavm.Reg) {
	i.regs[dst] = bits.ReverseBytes64(i.regs[s])
}

// StoreIndirectU8 store_ind_u8 μ′↺_{ωB+νX} = ωA mod 2^8
func (i *Instance) StoreIndirectU8(src polkavm.Reg, base polkavm.Reg, offset uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint8(i.regs[src]))
}

// StoreIndirectU16 store_ind_u16 μ′↺_{ωB+νX...+2} = E2(ωA mod 2^16)
func (i *Instance) StoreIndirectU16(src polkavm.Reg, base polkavm.Reg, offset uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint16(i.regs[src]))
}

// StoreIndirectU32 store_ind_u32 μ′↺_{ωB+νX...+4} = E4(ωA mod 2^32)
func (i *Instance) StoreIndirectU32(src polkavm.Reg, base polkavm.Reg, offset uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint32(i.regs[src]))
}

// StoreIndirectU64 store_ind_u64 μ′↺_{ωB+νX...+8} = E8(ωA)
func (i *Instance) StoreIndirectU64(src polkavm.Reg, base polkavm.Reg, offset uint32) error {
	return i.store(uint32(i.regs[base])+offset, uint64(i.regs[src]))
}

// LoadIndirectU8 load_ind_u8 ω′A = μ↺_{ωB+νX}
func (i *Instance) LoadIndirectU8(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	slice := make([]byte, 1)
...
func (i *Instance) LoadIndirectI8(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	slice := make([]byte, 1)
	if err := i.memory.Read(uint32(i.regs[base])+offset, slice); err != nil {
		return err
	}
...
func (i *Instance) LoadIndirectU16(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	var v uint16
	if err := i.load(uint32(i.regs[base])+offset, 2, &v); err != nil {
		return err
	}
	i.setAndSkip64(dst, uint64(v))
	return nil
...
func (i *Instance) LoadIndirectI16(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	var v int16
	if err := i.load(uint32(i.regs[base])+offset, 2, &v); err != nil {
		return err
	}
...
func (i *Instance) LoadIndirectU32(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	var v uint32
	if err := i.load(uint32(i.regs[base])+offset, 4, &v); err != nil {
		return err
	}
	i.setAndSkip32(dst, v)
	return nil
...
func (i *Instance) LoadIndirectI32(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	var v int32
	if err := i.load(uint32(i.regs[base])+offset, 4, &v); err != nil {
		return err
	}
...
func (i *Instance) LoadIndirectU64(dst polkavm.Reg, base polkavm.Reg, offset uint32) error {
	var v uint64
	if err := i.load(uint32(i.regs[base])+offset, 8, &v); err != nil {
		return err
	}
	i.setAndSkip64(dst, v)
	return nil
...
func (i *Instance) AddImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])+value)
}

// AndImm and_imm ∀i ∈ N64 ∶ B8(ω′A)_i = B8(ωB)_i ∧ B8(νX)_i
func (i *Instance) AndImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])&value)
}

// XorImm xor_imm ∀i ∈ N64 ∶ B8(ω′A)i = B8(ωB)_i ⊕ B8(νX)_i
func (i *Instance) XorImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])^value)
}

// OrImm or_imm ∀i ∈ N64 ∶ B8(ω′A)i = B8(ωB)_i ∨ B8(νX)_i
func (i *Instance) OrImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])|value)
}

// MulImm32 mul_imm_32 ω′A = X4((ωB ⋅ νX ) mod 2^32)
func (i *Instance) MulImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])*value)
}

// SetLessThanUnsignedImm set_lt_u_imm ω′A = ωB < νX
func (i *Instance) SetLessThanUnsignedImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, bool2uint32(uint32(i.regs[regA]) < value))
}

// SetLessThanSignedImm set_lt_s_imm ω′A = Z8(ωB) < Z8(νX)
func (i *Instance) SetLessThanSignedImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, bool2uint32(int32(uint32(i.regs[regA])) < int32(value)))
}

// ShiftLogicalLeftImm32 shlo_l_imm_32 ω′A = X4((ωB ⋅ 2νX mod 32) mod 2^32)
func (i *Instance) ShiftLogicalLeftImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])<<value)
}

// ShiftLogicalRightImm32 shlo_r_imm_32 ω′A = X4(⌊ ωB mod 232 ÷ 2νX mod 32 ⌋)
func (i *Instance) ShiftLogicalRightImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(i.regs[regA])>>value)
}

// ShiftArithmeticRightImm32 shar_r_imm_32 ω′A = Z−1_8(⌊ Z4(ωB mod 232) ÷ 2νX mod 32 ⌋)
func (i *Instance) ShiftArithmeticRightImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(int32(uint32(i.regs[regA]))>>value))
}

// NegateAndAddImm32 neg_add_imm_32 ω′A = X4((νX + 2^32 − ωB) mod 2^32)
func (i *Instance) NegateAndAddImm32(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, value-uint32(i.regs[regA]))
}

// SetGreaterThanUnsignedImm set_gt_u_imm ω′A = ωB > νX
func (i *Instance) SetGreaterThanUnsignedImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, bool2uint32(uint32(i.regs[regA]) > value))
}

// SetGreaterThanSignedImm set_gt_s_imm ω′A = Z8(ωB ) > Z8(νX)
func (i *Instance) SetGreaterThanSignedImm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, bool2uint32(int32(uint32(i.regs[regA])) > int32(value)))
}

// ShiftLogicalLeftImmAlt32 shlo_l_imm_alt_32 ω′A = X4((νX ⋅ 2ωB mod 32) mod 2^32)
func (i *Instance) ShiftLogicalLeftImmAlt32(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, value<<uint32(i.regs[regB]))
}

// ShiftLogicalRightImmAlt32 shlo_r_imm_alt_32 ω′A = X4(⌊ νX mod 2^32 ÷ 2ωB mod 32 ⌋)
func (i *Instance) ShiftLogicalRightImmAlt32(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(value)>>uint32(i.regs[regB]))
}

// ShiftArithmeticRightImmAlt32 shar_r_imm_alt_32 ω′A = Z−1_8(⌊ Z4(νX mod 2^32) ÷ 2ωB mod 32 ⌋)
func (i *Instance) ShiftArithmeticRightImmAlt32(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, uint32(int32(uint32(value))>>uint32(i.regs[regB])))
}

// CmovIfZeroImm cmov_iz_imm ω′A = νX if ωB = 0 otherwise ωA
func (i *Instance) CmovIfZeroImm(dst polkavm.Reg, c polkavm.Reg, s uint32) {
...
func (i *Instance) CmovIfNotZeroImm(dst polkavm.Reg, c polkavm.Reg, s uint32) {
	if uint32(i.regs[c]) != 0 {
		i.regs[dst] = uint64(s)
	}
...
func (i *Instance) AddImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, i.regs[regA]+uint64(value))
}

// MulImm64 mul_imm_64 ω′A = (ωB ⋅ νX) mod 2^64
func (i *Instance) MulImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, i.regs[regA]*uint64(value))
}

// ShiftLogicalLeftImm64 shlo_l_imm_64 ω′A = X8((ωB ⋅ 2νX mod 64) mod 2^64)
func (i *Instance) ShiftLogicalLeftImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, i.regs[regA]<<value)
}

// ShiftLogicalRightImm64 shlo_r_imm_64 ω′A = X8(⌊ ωB ÷ 2νX mod 64 ⌋)
func (i *Instance) ShiftLogicalRightImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, i.regs[regA]>>value)
}

// ShiftArithmeticRightImm64 shar_r_imm_64 ω′A = Z−1_8(⌊ Z8(ωB) ÷ 2νX mod 64 ⌋)
func (i *Instance) ShiftArithmeticRightImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, uint64(int64(i.regs[regA])>>value))
}

// NegateAndAddImm64 neg_add_imm_64 ω′A = (νX + 2^64 − ωB) mod 2^64
func (i *Instance) NegateAndAddImm64(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, uint64(value)-i.regs[regA])
}

// ShiftLogicalLeftImmAlt64 shlo_l_imm_alt_64 ω′A = (νX ⋅ 2ωB mod 64) mod 2^64
func (i *Instance) ShiftLogicalLeftImmAlt64(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, value<<uint32(i.regs[regB]))
}

// ShiftLogicalRightImmAlt64 shlo_r_imm_alt_64 ω′A = ⌊ νX ÷ 2ωB mod 64 ⌋
func (i *Instance) ShiftLogicalRightImmAlt64(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip32(dst, value>>uint32(i.regs[regB]))
}

// ShiftArithmeticRightImmAlt64 shar_r_imm_alt_64 ω′A = Z−1_8(⌊ Z8(νX) ÷ 2ωB mod 64 ⌋)
func (i *Instance) ShiftArithmeticRightImmAlt64(dst polkavm.Reg, regB polkavm.Reg, value uint32) {
	i.setAndSkip64(dst, uint64(int64(value)>>i.regs[regB]))
}

// RotateRight64Imm rot_r_64_imm ∀i ∈ N64 ∶ B8(ω′A)_i = B8(ωB)_{(i+νX) mod 64}
func (i *Instance) RotateRight64Imm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.regs[dst] = bits.RotateLeft64(i.regs[regA], -int(value))
}

// RotateRight64ImmAlt rot_r_64_imm_alt ∀i ∈ N64 ∶ B8(ω′A)i = B8(νX)_{(i+ωB) mod 64}
func (i *Instance) RotateRight64ImmAlt(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.regs[dst] = bits.RotateLeft64(uint64(value), -int(i.regs[regA]))
}

// RotateRight32Imm rot_r_32_imm ω′A = X4(x) where x ∈ N2^32, ∀i ∈ N32 ∶ B4(x)_i = B4(ωB)_{(i+νX ) mod 32}
func (i *Instance) RotateRight32Imm(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.regs[dst] = uint64(bits.RotateLeft32(uint32(i.regs[regA]), -int(value)))
}

// RotateRight32ImmAlt rot_r_32_imm_alt ω′A = X4(x) where x ∈ N2^32, ∀i ∈ N32 ∶ B4(x)_i = B4(νX)_{(i+ωB) mod 32}
func (i *Instance) RotateRight32ImmAlt(dst polkavm.Reg, regA polkavm.Reg, value uint32) {
	i.regs[dst] = uint64(bits.RotateLeft32(value, -int(uint32(i.regs[regA]))))
}

// BranchEq branch_eq branch(νX, ωA = ωB)
func (i *Instance) BranchEq(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
	return i.branch(uint32(i.regs[regA]) == uint32(i.regs[regB]), target)
}

// BranchNotEq branch_ne branch(νX, ωA ≠ ωB)
func (i *Instance) BranchNotEq(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
	return i.branch(uint32(i.regs[regA]) != uint32(i.regs[regB]), target)
}

// BranchLessUnsigned branch_lt_u branch(νX, ωA < ωB)
func (i *Instance) BranchLessUnsigned(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
	return i.branch(uint32(i.regs[regA]) < uint32(i.regs[regB]), target)
}

// BranchLessSigned branch_lt_s branch(νX, Z8(ωA) < Z8(ωB))
func (i *Instance) BranchLessSigned(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
...
func (i *Instance) BranchGreaterOrEqualUnsigned(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
	return i.branch(uint32(i.regs[regA]) >= uint32(i.regs[regB]), target)
}

// BranchGreaterOrEqualSigned branch_ge_s branch(νX, Z8(ωA) ≥ Z8(ωB))
func (i *Instance) BranchGreaterOrEqualSigned(regA polkavm.Reg, regB polkavm.Reg, target uint32) error {
	return i.branch(int32(uint32(i.regs[regA])) >= int32(uint32(i.regs[regB])), target)
}

// LoadImmAndJumpIndirect load_imm_jump_ind djump((ωB + νY) mod 232), ω′A = νX
func (i *Instance) LoadImmAndJumpIndirect(ra polkavm.Reg, base polkavm.Reg, value, offset uint32) error {
	target := uint32(i.regs[base]) + offset
...
func (i *Instance) Add32(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.setAndSkip32(dst, uint32(i.regs[regA])+uint32(i.regs[regB]))
}
...
func (i *Instance) ShiftLogicalLeft32(dst polkavm.Reg, regA, regB polkavm.Reg) {
	...
	shiftedValue := uint32(i.regs[regA]) << shiftAmount
	i.setAndSkip32(dst, shiftedValue)
}
...
func (i *Instance) ShiftLogicalRight32(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.setAndSkip32(dst, uint32(i.regs[regA])>>(uint32(i.regs[regB])%32))
}
...
func (i *Instance) ShiftLogicalLeft64(dst polkavm.Reg, regA, regB polkavm.Reg) {
	shiftAmount := uint32(i.regs[regB]) % 64
	shiftedValue := uint32(i.regs[regA]) << shiftAmount
	i.setAndSkip32(dst, shiftedValue)
}
...
func (i *Instance) ShiftLogicalRight64(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.setAndSkip64(dst, i.regs[regA]>>(i.regs[regB]%64))
}
...
func (i *Instance) ShiftArithmeticRight64(dst polkavm.Reg, regA, regB polkavm.Reg) {
	...
	i.setAndSkip64(dst, uint64(shiftedValue))
}
...
func (i *Instance) MulUpperSignedSigned(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.setAndSkip32(dst, uint32(int32((int64(uint32(i.regs[regA]))*int64(uint32(i.regs[regB])))>>32)))
}

// MulUpperUnsignedUnsigned mul_upper_u_u ω′D = ⌊ (ωA ⋅ ωB ) ÷ 264 ⌋
...
func (i *Instance) RotateLeft64(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.regs[dst] = bits.RotateLeft64(i.regs[regA], int(i.regs[regB]))
}
...
func (i *Instance) RotateLeft32(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.regs[dst] = uint64(bits.RotateLeft32(uint32(i.regs[regA]), int(uint32(i.regs[regB]))))
}
...
func (i *Instance) AndInverted(dst polkavm.Reg, regA, regB polkavm.Reg) {
	i.regs[dst] = i.regs[regA] &^ i.regs[regB]
}
