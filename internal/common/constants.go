...
const (
	...
	MaxWorkPackageSize                           = 13_794_305                                                   // WB = 13,794,305: The maximum size of an encoded work-package together with its extrinsic data and import implications, in octets
